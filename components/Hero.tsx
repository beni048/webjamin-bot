...
const Hero = () => {
  return (
    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row ">
        ...
        <div className="relative z-20 flex flex-1 flex-col xls:w-1/2">
            <Image
                src="/camp.svg"
                alt="camp"
                width={50}
            ...
            />
            <h1 className="bold-52 lg:bold-88">Webjamin Camp Area</h1>
            ...
            <div className="my-11 flex flex-wrap gap-5">
                ...
                <p className="bold-16 lg:bold-20 text-blue-70">
                    198k
                    <span className="regular-16 lg:regular-29 ml-1">
                        Excellent Reviews
                    </span>
                </p>
            </div>
